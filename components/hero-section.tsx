    ...
    <section className="relative z-10 min-h-screen flex items-center justify-center px-4">
      <div className="max-w-4xl mx-auto text-center">
        <div className="mb-6 flex items-center justify-center gap-3 flex-wrap">
          <span className="inline-block px-4 py-2 rounded-full bg-secondary/50 text-primary text-sm font-medium border border-primary/20">
            {t("hero.location")}
          </span>
        </div>
        ...
        <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-muted-foreground">
          {t("hero.title")} <span className="text-primary">{t("hero.devops")}</span> & <span className="text-primary">{t("hero.cloud")}</span>
        </h2>
